                ...
                <div class="move r" v-show="close == false">
                    ...
                    <div class="history">
                        ...
                        <div class="other" v-if="$store.state.loginMethod == 1">
                            <!-- <a v-facebook-login-button="appId" class="l" style="width: 118px; margin: 0 0 0 36px;"
                                ><i
                                    ><img
                                ...
                                >Facebook</a
                            > -->
                            <facebook-login class="fb_button"
                                :appId="appId"
                                loginLabel="Facebook"
                                logoutLabel="Facebook"
                                @login="getUserData"
                                @logout="onLogout">
                            </facebook-login>
                            <!-- @get-initial-status="getUserData" -->
                            <!-- <a v-google-signin-button="clientId" class="l" style="width: 118px; margin: 0 0 0 36px;"
                                ><i
                                    ><img
                                        style="width: 22px; height: 22px;"
                                ...
                                >Google</a
                            > -->
                            <GoogleLogin :params="params" :onSuccess="onSuccess" class="google_button">
                                <a class="l" style="width: 118px; margin: 20px 0 0 36px; background: #de5246;">
                                    <i
                                        ><img
...
export default {
    ...
    methods: {
        ...
        //     console.log("google clientId", idToken);
        //     this.HTTP(this.$httpConfig.getLogin, {
        ...
        //     console.log("facebook appId", idToken)
        // },
        ...
        emailAbtain() {
            ...
            if (
                ...
                this.mob_login_text = "请输入正确的邮箱地址";
                return false;
            }
            this.HTTP(
