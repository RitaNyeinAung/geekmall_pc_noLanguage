                    ...
                    <div class="middle l">
                        ...
                        <div class="peisong">
                            ...
                            <p class="distance1">
                                ...
                                <span v-if="info.freight_type == 2">
                                    <span class="yunfei">运费：卖家包邮</span>
                                </span>

                                <span v-if="info.is_presell == 0" class="delivery_time">有现货</span>
                                <span v-if="info.is_presell == 1" class="delivery_time">预售商品</span>
                            ...
                            <p class="delivery_pay">
                                发货时间
                                <span>付款后&nbsp;<span>{{info.presell_date}}</span>&nbsp;天内发货</span>
                            </p>
                        </div> 
                        <!-- <div class="leiji">
                            <div class="leijiText">
                        ...
                        <div class="leiji">
                            <div class="leijiText">
                                累计评价
                                <span class="leijiSpan">{{ sale_info.count }}人评价</span>
                            </div>
                            <div class="leijiText">
                                累计销量
                                <span class="leijiSpan">{{ sale_info.sales_sum || 0 }}</span>
                            </div>
                            <div class="leijiText">
                                赠送积分
                                <span class="leijiSpan">{{
                                    (
                                        info.price_member / sale_info.integral
                                    ).toFixed(0) || 0
                                }}</span>
                            </div>
                        </div>
