                ...
                <div class="central l">
                    ...
                    <div class="buy">
                        ...
                        >
                          <div class="r img-scan">
                            手机购买<img
                                @mouseenter="handleScan($route.query.goods_id)"
                                @mouseleave="handleLeave"
                                src="@/assets/img/samllerweima.jpg"
                                alt=""
                            />
    ...
    this.shipping_data = res.data.data.shipping;
        ...
        handleScan(id) {
            new QRCode(this.$refs.qrCodeDiv, {
                text:
                    "http://m.geekmall.plus/integralDetail/" +
                    id +
                    "/" +
                    2 +
                    "?type=" +
        ...
        comTime() {
            ...
            if (this.goodsData.start_time > now) {
                // this.showTimeType = 0;
                this.getTime(this.goodsData.start_time);
            } else if (now > this.goodsData.start_time && now < this.goodsData.end_time) {
                // this.showTimeType = 1;
