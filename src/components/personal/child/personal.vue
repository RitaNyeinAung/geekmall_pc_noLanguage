<template>
	<div class="personal">
		...
		<div class="xinxi" v-show="hidden==0">
			...
			<p class="touxiang redact">当前头像：
				<!-- <img :src="URL+userInfo.user_header" v-if="userInfo.user_header" />
				<img v-else src="../../../assets/img/default-head.png" /> -->
				<span v-if="userInfo.user_header">
					<img :src="URL+userInfo.user_header" v-if="userInfo.user_header.split(':').length == 1" onerror="this.src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortRound&accessoriesType=Blank&hairColor=Black&facialHairType=Blank&clotheType=BlazerShirt&eyeType=WinkWacky&eyebrowType=Default&mouthType=Default&skinColor=Light'" />
					<img :src="userInfo.user_header" v-if="userInfo.user_header.split(':').length == 2" onerror="this.src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortRound&accessoriesType=Blank&hairColor=Black&facialHairType=Blank&clotheType=BlazerShirt&eyeType=WinkWacky&eyebrowType=Default&mouthType=Default&skinColor=Light'" />
				</span>
				<span v-else>
				...
				<div class="lefts l">
					<div class="img-cont">
						...
						<div v-if="userInfo.user_header">
							<img width="150px" height="150px" :src="URL+userInfo.user_header" v-if="userInfo.user_header.split(':').length == 1" onerror="this.src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortRound&accessoriesType=Blank&hairColor=Black&facialHairType=Blank&clotheType=BlazerShirt&eyeType=WinkWacky&eyebrowType=Default&mouthType=Default&skinColor=Light'" />
							<img width="150px" height="150px" :src="userInfo.user_header" v-if="userInfo.user_header.split(':').length == 2" onerror="this.src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortRound&accessoriesType=Blank&hairColor=Black&facialHairType=Blank&clotheType=BlazerShirt&eyeType=WinkWacky&eyebrowType=Default&mouthType=Default&skinColor=Light'" />
						</div>
						<div v-else>
							<img width="150px" height="150px" src="https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortRound&accessoriesType=Blank&hairColor=Black&facialHairType=Blank&clotheType=BlazerShirt&eyeType=WinkWacky&eyebrowType=Default&mouthType=Default&skinColor=Light" onerror="this.src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortRound&accessoriesType=Blank&hairColor=Black&facialHairType=Blank&clotheType=BlazerShirt&eyeType=WinkWacky&eyebrowType=Default&mouthType=Default&skinColor=Light'"/>
						</div>
					</div>
				</div>
				<div class="right l">
        ...
        .then(res => {
           if (res.data.status == 10001) {
            ...
            if (res.data.status === 1) {
							...
							this.prohibit = false;
							this.userInfo.user_header = res.data.pic;
            } else {
              this.$message.info(res.data.message);
            }
          }
