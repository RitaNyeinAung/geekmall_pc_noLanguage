                            ...
                            <li class="cart-item" v-for="(d,index) in item.goods" :key="d.id">
                                <div class="cart-goods-info clearfix">
                                    ...
                                    <div class="cart-info r">
                                        <div class="goods-price text1-hidden r">¥{{d.price_member}}×{{d.goods_num}}</div>
            ...
            countTotal() {
                ...
                for (let i = 0; i < this.cartData.length; i++) {
                    for (let index = 0; index < this.cartData[i].goods.length; index++) {
                        ...
                        totalPrice += parseInt(this.cartData[i].goods[index].goods_num) * parseFloat(this.cartData[i].goods[index].price_member);
                    }
                }
                return {
                    totalNum,
        ...
        methods: {
            ...
            getCartData() {
                this.HTTP(this.$httpConfig.cartGoodsList, {}, 'post', true).then((res) => {
                    ...
                    this.cartData = res.data.data.goods;
                    if (this.cartData.length == 0) {
                        this.onoff = true;
                        this.onoff1 = false;
                    } else {
